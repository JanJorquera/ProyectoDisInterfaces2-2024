    ...
    <div className='layout'>
      ...
      <div className='layout__page'>
        <Routes>
          ...
          <Route path='/detalle-denuncias' element={<ReportDetail isAdmin={isAdmin}/>}/>
